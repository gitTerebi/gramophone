...
exports.extract = function (text, options) {
  ...
  _.each(options.ngrams, function (ngram) {
    ...
    var tokenized = _.map(ngrams(text, ngram), function (ngram) {
      if (options.stem) {
...
exports.combine = function (phrases, cutoff) {
  ...
  _.each(_.keys(phrases), function (phrase) {
    ...
    _.each(ngrams(phrase, ngramToTry), function (ngram) {
...
function usePhrase(phrase, options) {
  return whitelisted(phrase, options.startWords) || !_.detect(phrase.split(' '), function (term) {
